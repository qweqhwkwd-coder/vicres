...
(function () {
  ...
  add("en", {
    ...
    faq_a2: "Volhynia's history is painful, but a great deal still survives across Ukrainian and Polish archives. I check multiple sources and explain honestly what is realistic before you commit.",
    ...
    faq_a4: "I specialise in Rivne and Volhynia, and my research can cover other regions of Ukraine and Poland. Consultations are available in Ukrainian, Polish and English.",
  ...
  add("uk", {
    ...
    faq_a2: "Історія Волині болюча, але багато матеріалів збереглося в українських і польських архівах. Я перевіряю різні джерела й чесно пояснюю, що реально знайти, ще до початку роботи.",
    ...
    faq_a4: "Спеціалізуюся на Рівному та Волині, а дослідження можуть охоплювати й інші регіони України та Польщі. Консультації проводжу українською, польською та англійською.",
  ...
  add("pl", {
    ...
    faq_a2: "Historia Wołynia jest bolesna, ale wiele materiałów zachowało się w archiwach ukraińskich i polskich. Sprawdzam różne źródła i uczciwie wyjaśniam, co jest realne, zanim podejmiesz decyzję.",
    ...
    faq_a4: "Specjalizuję się w Równem i na Wołyniu, a badania mogą obejmować także inne regiony Ukrainy i Polski. Konsultacje prowadzę po ukraińsku, polsku i angielsku.",
  ...
  add("he", {
    ...
    reassure: "התחילו משם משפחה, שם עיירה או מסמך ישן אחד — אין צורך בעץ יוחסין מוכן.",
    ...
    faq_a2: "ההיסטוריה של ווהלין כואבת, אך חומר רב שרד בארכיונים אוקראיניים ופולניים. אני בודקת מקורות שונים ומסבירה בכנות מה ריאלי — עוד לפני שתתחייבו.",
    ...
    faq_a4: "אני מתמחה ברובנה ובאזור ווהלין, והמחקר יכול לכלול אזורים נוספים באוקראינה ובפולין. הייעוץ זמין באוקראינית, בפולנית ובאנגלית.",
