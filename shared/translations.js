...
window.VICRES_I18N = {
  ...
  en: {
    ...
    f_focus: "Focus",
    v_focus: "Volhynia · Rivne · Jewish heritage",
    f_exp: "Experience",
    ...
    about_p1: "For more than fifteen years I have worked inside Ukrainian and Polish archives, specialising in the Jewish history and heritage of Rivne (Rowne) and the wider Volhynia region.",
    about_p2: "I studied Jewish History and Culture at the Historical Faculty of the University of Warsaw, collaborated with the POLIN Museum of the History of Polish Jews, and have indexed handwritten records and Jewish cemeteries across Volhynian shtetls.",
    ...
    cred_polin_d: "Collaboration on the history of Polish Jews",
  ...
  uk: {
    ...
    v_focus: "Волинь · Рівне · єврейська спадщина",
    f_exp: "Досвід",
    ...
    about_p2: "Вивчала єврейську історію та культуру на історичному факультеті Варшавського університету, співпрацювала з Музеєм історії польських євреїв POLIN, індексувала рукописні записи та єврейські цвинтарі волинських містечок.",
    ...
    cred_polin_d: "Співпраця з історії польських євреїв",
  ...
  pl: {
    ...
    v_focus: "Wołyń · Równe · dziedzictwo żydowskie",
    f_exp: "Doświadczenie",
    ...
    about_p2: "Studiowałam historię i kulturę Żydów na Wydziale Historycznym Uniwersytetu Warszawskiego, współpracowałam z Muzeum Historii Żydów Polskich POLIN oraz indeksowałam rękopiśmienne zapisy i cmentarze żydowskie wołyńskich sztetli.",
    ...
    cred_polin_d: "Współpraca — historia Żydów polskich",
  ...
  he: {
    ...
    f_focus: "התמחות",
    v_focus: "ווהלין · רובנה · מורשת יהודית",
    f_exp: "ניסיון",
    ...
    about_p2: "למדתי היסטוריה ותרבות יהודית בפקולטה להיסטוריה באוניברסיטת ורשה, שיתפתי פעולה עם מוזיאון POLIN לתולדות יהודי פולין, ואינדקסתי רשומות בכתב יד ובתי עלמין יהודיים בעיירות ווהלין.",
    ...
    cred_polin_d: "שיתוף פעולה — תולדות יהודי פולין",
